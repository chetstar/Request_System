...
class Request(Form):
    ...
    jobTitle= TextField('This will be the ID we use to communicate about the request.',validators=[validators.Required()])
    ...
    deadlinetime = SelectField(u'What Hour?',coerce=str, choices=[(8,'8 am'), (9, '9 am'), (10, '10 am'), (11, '11 am'), (12, 'noon'), (13, '1 pm'), (14, '2 pm'), (15, '3 pm'), (16, '4 pm'), (17, '5 pm')])
